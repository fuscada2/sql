...
SELECT vendor_id, COUNT(booth_number) as rent_number
...
--Wasn't sure if it's also asking for customer_id, so I'm returning that too
...
--Make the table (checking to see if it exists first)
...
--Check to make sure this worked (commented out after running)
